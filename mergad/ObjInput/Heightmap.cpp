...
//		myfile.open("normal.txt");
	...
	for (int i = 0; i < ((hminfo.terrainwidth - 1)*(hminfo.terrainheight - 1) * 2); ++i)
	{
		...
		//	normalen
		//	XMStoreFloat3(&onormaliserad, XMVector3Cross(edge[0], edge[1])); //XMvector3cross är crossmultiplikation inbyggt<3 XMStorefloat3 först var lagras datan, sedan vector var datan finns.
